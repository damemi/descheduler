...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*NamespacedTopologySpreadConstraint)(nil), (*api.NamespacedTopologySpreadConstraint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_NamespacedTopologySpreadConstraint_To_api_NamespacedTopologySpreadConstraint(a.(*NamespacedTopologySpreadConstraint), b.(*api.NamespacedTopologySpreadConstraint), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.NamespacedTopologySpreadConstraint)(nil), (*NamespacedTopologySpreadConstraint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_NamespacedTopologySpreadConstraint_To_v1alpha1_NamespacedTopologySpreadConstraint(a.(*api.NamespacedTopologySpreadConstraint), b.(*NamespacedTopologySpreadConstraint), scope)
	}); err != nil {
		return err
	}
	...
	if err := s.AddGeneratedConversionFunc((*TopologySpreadConstraint)(nil), (*api.TopologySpreadConstraint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_TopologySpreadConstraint_To_api_TopologySpreadConstraint(a.(*TopologySpreadConstraint), b.(*api.TopologySpreadConstraint), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*api.TopologySpreadConstraint)(nil), (*TopologySpreadConstraint)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_api_TopologySpreadConstraint_To_v1alpha1_TopologySpreadConstraint(a.(*api.TopologySpreadConstraint), b.(*TopologySpreadConstraint), scope)
	}); err != nil {
		return err
	}
	return nil
